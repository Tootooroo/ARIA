    ...
    >
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        ...
        >
          ...
          {/* Buttons */}
          <View style={styles.buttonGroup} pointerEvents="box-none">
            <TouchableOpacity
          ...
          {/* Footer absolutely at the bottom — ensure it doesn't eat touches */}
          <View style={styles.footer} pointerEvents="box-none">
            <Text style={styles.betaText}>Beta 1.0.3 Version</Text>
          </View>
        </View>
      </SafeAreaView>
    </ImageBackground>
